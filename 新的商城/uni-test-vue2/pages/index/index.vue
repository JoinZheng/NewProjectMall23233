<template>
	<view class="content">
		...
		<view class="data-margintop dataInfo" style="padding: 0px; background-color: transparent;">
			<van-row>
				<van-col span="4">
					<van-popover v-model="showPopover" trigger="click" :actions="actions" @select="onSelectSort">
						<template #reference>
			...
			<view class="carAllInfo">
				<view class="carInfo">
					...
					<view class="carAdd">服务点 <view class="carJu">324m</view>
					</view>
				</view>
				<view class="carInfo">
					<image class="carImg" src="../../static/carInfo.png"></image>
		...
		<van-popup v-model:show="showList" round position="bottom" style="height: 90%; padding-top: 4px;">
			<van-coupon-list @change="onChange" @exchange="onExchange" />
		</van-popup>
	</view>
</template>
